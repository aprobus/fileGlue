...
function tear (filePath, opts, callback) {
  ...
  tearFile(filePath, path.dirname(filePath), path.basename(filePath), tearSize, callback);
}

function tearFile (readPath, outputDir, outputFilePrefix, tearSize, callback) {
